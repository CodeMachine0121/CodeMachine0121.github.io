...
test.describe('Article Sticky Notes', () => {
  ...
  test('TC-19 saving from the detail view upserts the content and returns to the list', { tag: ['@ui'] }, async ({ Given, When, Then, And, page }) => { 
    await Given('the viewport is narrow', null, { page }); 
    await And('the article is preloaded with 1 sticky notes', null, { page }); 
    await When('I click the sticky-notes button', null, { page }); 
    await And('I open the first panel note', null, { page }); 
    await And('I edit the detail text to "已更新內容"', null, { page }); 
    await And('I save the detail view', null, { page }); 
    await Then('the sticky-notes detail view should be hidden', null, { page }); 
    await And('the notes panel should list 1 notes', null, { page }); 
    await When('I reload the page', null, { page }); 
    await And('I click the sticky-notes button', null, { page }); 
    await And('I open the first panel note', null, { page }); 
    await Then('the detail view should show note text "已更新內容"', null, { page }); 
  });
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":173,"pickleLine":152,"tags":["@ui"],"steps":[{"pwStepLine":174,"gherkinStepLine":153,"keywordType":"Context","textWithKeyword":"Given the viewport is narrow","stepMatchArguments":[]},{"pwStepLine":175,"gherkinStepLine":154,"keywordType":"Context","textWithKeyword":"And the article is preloaded with 1 sticky notes","stepMatchArguments":[{"group":{"start":30,"value":"1"},"parameterTypeName":"int"}]},{"pwStepLine":176,"gherkinStepLine":155,"keywordType":"Action","textWithKeyword":"When I click the sticky-notes button","stepMatchArguments":[]},{"pwStepLine":177,"gherkinStepLine":156,"keywordType":"Action","textWithKeyword":"And I open the first panel note","stepMatchArguments":[]},{"pwStepLine":178,"gherkinStepLine":157,"keywordType":"Action","textWithKeyword":"And I edit the detail text to \"已更新內容\"","stepMatchArguments":[{"group":{"start":26,"value":"\"已更新內容\"","children":[{"start":27,"value":"已更新內容","children":[{}]},{"children":[{}]}]},"parameterTypeName":"string"}]},{"pwStepLine":179,"gherkinStepLine":158,"keywordType":"Action","textWithKeyword":"And I save the detail view","stepMatchArguments":[]},{"pwStepLine":180,"gherkinStepLine":159,"keywordType":"Outcome","textWithKeyword":"Then the sticky-notes detail view should be hidden","stepMatchArguments":[]},{"pwStepLine":181,"gherkinStepLine":160,"keywordType":"Outcome","textWithKeyword":"And the notes panel should list 1 notes","stepMatchArguments":[{"group":{"start":28,"value":"1"},"parameterTypeName":"int"}]},{"pwStepLine":182,"gherkinStepLine":161,"keywordType":"Action","textWithKeyword":"When I reload the page","stepMatchArguments":[]},{"pwStepLine":183,"gherkinStepLine":162,"keywordType":"Action","textWithKeyword":"And I click the sticky-notes button","stepMatchArguments":[]},{"pwStepLine":184,"gherkinStepLine":163,"keywordType":"Action","textWithKeyword":"And I open the first panel note","stepMatchArguments":[]},{"pwStepLine":185,"gherkinStepLine":164,"keywordType":"Outcome","textWithKeyword":"Then the detail view should show note text \"已更新內容\"","stepMatchArguments":[{"group":{"start":38,"value":"\"已更新內容\"","children":[{"start":39,"value":"已更新內容","children":[{}]},{"children":[{}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":188,"pickleLine":166,"tags":["@ui"],"steps":[{"pwStepLine":189,"gherkinStepLine":167,"keywordType":"Context","textWithKeyword":"Given I am on the \"/blogs/clean-architecture-with-asp-dotnet-core-10\" page","stepMatchArguments":[{"group":{"start":12,"value":"\"/blogs/clean-architecture-with-asp-dotnet-core-10\"","children":[{"start":13,"value":"/blogs/clean-architecture-with-asp-dotnet-core-10","children":[{}]},{"children":[{}]}]},"parameterTypeName":"string"}]},{"pwStepLine":190,"gherkinStepLine":168,"keywordType":"Outcome","textWithKeyword":"Then the sticky-notes button should be hidden","stepMatchArguments":[]}]},
  {"pwTestLine":193,"pickleLine":170,"tags":["@ui"],"steps":[{"pwStepLine":194,"gherkinStepLine":171,"keywordType":"Context","textWithKeyword":"Given I am on the \"/blogs/clean-architecture-with-asp-dotnet-core-10\" page","stepMatchArguments":[{"group":{"start":12,"value":"\"/blogs/clean-architecture-with-asp-dotnet-core-10\"","children":[{"start":13,"value":"/blogs/clean-architecture-with-asp-dotnet-core-10","children":[{}]},{"children":[{}]}]},"parameterTypeName":"string"}]},{"pwStepLine":195,"gherkinStepLine":172,"keywordType":"Action","textWithKeyword":"When I triple-click in the left margin","stepMatchArguments":[]},{"pwStepLine":196,"gherkinStepLine":173,"keywordType":"Action","textWithKeyword":"And I type \"不失焦也要存\" into the focused note without blurring","stepMatchArguments":[{"group":{"start":7,"value":"\"不失焦也要存\"","children":[{"start":8,"value":"不失焦也要存","children":[{}]},{"children":[{}]}]},"parameterTypeName":"string"}]},{"pwStepLine":197,"gherkinStepLine":174,"keywordType":"Action","textWithKeyword":"And I reload the page","stepMatchArguments":[]},{"pwStepLine":198,"gherkinStepLine":175,"keywordType":"Outcome","textWithKeyword":"Then there should be 1 sticky notes","stepMatchArguments":[{"group":{"start":16,"value":"1"},"parameterTypeName":"int"}]},{"pwStepLine":199,"gherkinStepLine":176,"keywordType":"Outcome","textWithKeyword":"And the sticky note should contain \"不失焦也要存\"","stepMatchArguments":[{"group":{"start":31,"value":"\"不失焦也要存\"","children":[{"start":32,"value":"不失焦也要存","children":[{}]},{"children":[{}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":202,"pickleLine":178,"tags":["@ui"],"steps":[{"pwStepLine":203,"gherkinStepLine":179,"keywordType":"Context","textWithKeyword":"Given the viewport is narrow","stepMatchArguments":[]},{"pwStepLine":204,"gherkinStepLine":180,"keywordType":"Context","textWithKeyword":"And I am on the \"/blogs/clean-architecture-with-asp-dotnet-core-10\" page","stepMatchArguments":[{"group":{"start":12,"value":"\"/blogs/clean-architecture-with-asp-dotnet-core-10\"","children":[{"start":13,"value":"/blogs/clean-architecture-with-asp-dotnet-core-10","children":[{}]},{"children":[{}]}]},"parameterTypeName":"string"}]},{"pwStepLine":205,"gherkinStepLine":181,"keywordType":"Action","textWithKeyword":"When I click the sticky-notes button","stepMatchArguments":[]},{"pwStepLine":206,"gherkinStepLine":182,"keywordType":"Action","textWithKeyword":"And I click the panel add button","stepMatchArguments":[]},{"pwStepLine":207,"gherkinStepLine":183,"keywordType":"Outcome","textWithKeyword":"Then the sticky-notes detail view should be visible","stepMatchArguments":[]},{"pwStepLine":208,"gherkinStepLine":184,"keywordType":"Action","textWithKeyword":"When I edit the detail text to \"新便利貼內容\"","stepMatchArguments":[{"group":{"start":26,"value":"\"新便利貼內容\"","children":[{"start":27,"value":"新便利貼內容","children":[{}]},{"children":[{}]}]},"parameterTypeName":"string"}]},{"pwStepLine":209,"gherkinStepLine":185,"keywordType":"Action","textWithKeyword":"And I go back from the detail view","stepMatchArguments":[]},{"pwStepLine":210,"gherkinStepLine":186,"keywordType":"Outcome","textWithKeyword":"Then the sticky-notes detail view should be hidden","stepMatchArguments":[]},{"pwStepLine":211,"gherkinStepLine":187,"keywordType":"Outcome","textWithKeyword":"And the notes panel should list 1 notes","stepMatchArguments":[{"group":{"start":28,"value":"1"},"parameterTypeName":"int"}]}]},
]; // bdd-data-end