...
test.describe('CV Page Redesign with Profile Picture & cv.json', () => {
  ...
  test('Header 顯示大頭照與基本資訊', { tag: ['@ui'] }, async ({ Given, Then, And, page }) => { 
    ...
    await And('I should see "Email"', null, { page }); 
  });
